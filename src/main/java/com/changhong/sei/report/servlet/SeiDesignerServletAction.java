...
public class SeiDesignerServletAction extends RenderPageServletAction {
    @Resource(name = "ureport.reportRender")
    private ReportRender reportRender;
    @Resource(name = "ureport.reportParser")
    ...
    public void setApplicationContext(ApplicationContext applicationContext)throws BeansException {
        ...
        Collections.sort(reportProviders, Comparator.comparing(ReportProvider::getName));
    }
