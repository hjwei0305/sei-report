...
public class XSSFExcelParser extends ExcelParser {
	...
	private com.changhong.sei.report.definition.CellStyle buildCellStyle(XSSFCell cell, XSSFWorkbook book){
		com.changhong.sei.report.definition.CellStyle style=new com.changhong.sei.report.definition.CellStyle();
		...
		if(!borderStyle.equals(BorderStyle.NONE)){
			...
			border.setStyle(com.changhong.sei.report.enums.BorderStyle.solid);
			border.setWidth(1);
